...
var Aufgabe6;
(function (Aufgabe6) {
    var SmallCloud = (function (_super) {
        __extends(SmallCloud, _super);
        ...
        SmallCloud.prototype.draw = function () {
            ...
            Aufgabe6.crc2.arc(this.x - 35, this.y, 25, 0, 2 * Math.PI);
            Aufgabe6.crc2.fillStyle = this.color;
            Aufgabe6.crc2.fill();
            Aufgabe6.crc2.beginPath();
            Aufgabe6.crc2.arc(this.x, this.y, 25, 0, 2 * Math.PI);
            Aufgabe6.crc2.fillStyle = this.color;
            Aufgabe6.crc2.fill();
            Aufgabe6.crc2.beginPath();
            Aufgabe6.crc2.arc(this.x - 17, this.y - 21, 20, 0, 2 * Math.PI);
            Aufgabe6.crc2.fillStyle = this.color;
            Aufgabe6.crc2.fill();
        };
        return SmallCloud;
    }(Aufgabe6.MovingObject));
    Aufgabe6.SmallCloud = SmallCloud;
})(Aufgabe6 || (Aufgabe6 = {}));
